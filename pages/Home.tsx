...
export default function Home() {
  ...
  return (
    <main ref={containerRef} className="relative w-full overflow-x-hidden pb-32">
      ...
      {/* --- SECTION 1: HERO --- */}
      <section id="home" className="sticky top-0 min-h-screen w-full flex flex-col px-6 md:px-12 pt-8 pb-12 overflow-hidden">
        ...
        <div className="absolute top-[35%] right-6 md:right-12 z-20 text-right hidden md:block">
          <h2 className="text-4xl lg:text-6xl font-bold text-white/90 leading-[0.9] font-display tracking-tight mix-blend-overlay animate__animated animate__backInRight">
            Business Analyst<br />
            Web Developer
          </h2>
        </div>
