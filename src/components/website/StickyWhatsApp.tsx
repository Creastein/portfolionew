...
const StickyWhatsApp: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Button */}
      <div className="relative w-14 h-14 md:w-16 md:h-16 bg-[#25d366] rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.4)] group-hover:shadow-[0_4px_30px_rgba(37,211,102,0.6)] group-hover:scale-110 transition-all duration-300">
